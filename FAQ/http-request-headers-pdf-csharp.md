...
🇯🇵 **日本語:** [FAQ/http-request-headers-pdf-csharp.md](https://github.com/csharp-pdf-libraries/awesome-dotnet-pdf-libraries-2025-jp/blob/main/FAQ/http-request-headers-pdf-csharp.md)
