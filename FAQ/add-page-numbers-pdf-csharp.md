...
🇯🇵 **日本語:** [FAQ/add-page-numbers-pdf-csharp.md](https://github.com/csharp-pdf-libraries/awesome-dotnet-pdf-libraries-2025-jp/blob/main/FAQ/add-page-numbers-pdf-csharp.md)
